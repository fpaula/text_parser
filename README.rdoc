=Build status
{<img src="https://secure.travis-ci.org/fpaula/text_parser.png" />}[https://secure.travis-ci.org/fpaula/text_parser.png]
...
Site example: [url]http://textparser.heroku.com[/url]
